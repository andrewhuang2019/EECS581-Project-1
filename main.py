...
# Function written by John Rader
# draw the verity that is above the board
# VERITY_SMILE for normal playing
# VERITY_SUNGLASSES for win
# VERITY_DEAD for lose
def draw_verity(board):
    # offset is (1, 77)
    draw_coords = [89 - 1, 101 - 77]
    sprite_to_draw = Sprite.VERITY_SMILE
    if (board.is_game_won):
        sprite_to_draw = Sprite.VERITY_SUNGLASSES
    if (board.is_game_lost):
        sprite_to_draw = Sprite.VERITY_DEAD
